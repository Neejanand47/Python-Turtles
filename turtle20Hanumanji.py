...
def writesomething():
    tu.goto(250,100)
    tu.write("Python Programming Hub",font=("italian", "30", "bold"))
    tu.goto(210,50)
    tu.write("🙏 Jai Shri Ram 🙏",font=("italian", "30", "bold"))
